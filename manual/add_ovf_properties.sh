...
if [ "$(uname)" == "Darwin" ]; then
    ...
    sed -i .bak2 "/    <\/VirtualHardwareSection>/ r photon.xml" ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.ovf
    ...
    sed -i "/    <\/VirtualHardwareSection>/ r photon.xml" ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.ovf
...
ovftool --overwrite ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.ovf ${OUTPUT_PATH}/${FINAL_PHOTON_APPLIANCE_NAME}.ova
rm -rf ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}
rm -f photon.xml

rm -rf ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.ovf*
rm -rf ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.vmdk*
rm -rf ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}-*
rm -rf ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.v*
rm -rf ${OUTPUT_PATH}/${PHOTON_APPLIANCE_NAME}.nvram
rm -rf ${OUTPUT_PATH}/disk*
